										...
										<div class="modal-dialog modal-sm">
											<div class="modal-content">
											  ...
											  <div class="modal-body">
												<img src="<?php echo base_url('assets/files/users/'.$profile->personal_info_id.'/'.$profile->display_pic.''); ?>" class="img-responsive" title="<?php echo $profile->fname.' '.$profile->lname; ?>" alt="<?php echo $profile->fname.' '.$profile->lname; ?>" draggable="false" />
												<?php echo form_open_multipart('admin/profile/update/avatar'); ?>
											...
											<div class="tab-content p-2">
												<div class="tab-pane active" id="personal_info">
													<div class="portlet-body">
														...
														echo form_open('admin/profile/update/info',$personal_info_form); ?>
								...
								<div class="row profile-account">
									...
									<div class="col-md-9">
										<div class="tab-content p-1">
											...
											echo form_open('admin/profile/update/username',$username_form); ?>
													<div class="form-group">
											...
											echo form_open('admin/profile/update/password',$password_form); ?>											
													<div class="form-group">
